...
COMPOSER_BUCKET = "us-east1-demo-instance-a60ecfc7-bucket" ## change this 

GCS_JOB_FILE_1 = f"gs://{COMPOSER_BUCKET}/data/INGESTION/hospitalA_mysqlToLanding.py" #gs://us-east1-demo-instance-a60ecfc7-bucket/data/INGESTION/hospitalA_mysqlToLanding.py
PYSPARK_JOB_1 = {
